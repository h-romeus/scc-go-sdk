...
## Table of Contents
<!--
  The TOC below is generated by using the `markdown-toc` node package.

      https://github.com/jonschlinkert/markdown-toc

  Regenerate the TOC after making changes to this file.
...
### Go modules  
If your application uses Go modules for dependency management (as recommended), add an import for each service 
...
See the previous service table to find the appropriate package name for the services that are used by your application.

### `go get` command  
Alternatively, you can use the `go get` command to download and install the appropriate packages nhat are needed by your application:
```
go get -u github.com/IBM/scc-go-sdk/v5
```
Be sure to use the appropriate package name from the previous service table for the services that are used by your application.
...
Before that, please search for similar issues. It's possible that someone already reported the problem.
